  ...
  render: function (data, type, full, meta) {
    ...
    if (type != "display")
      return (Array.isArray(data) ? data : [data])
        .map((d) => d.toString().escape())
        .join(",");
    return `<span class="align-middle d-inline-block text-truncate" data-toggle="tooltip" data-placement="bottom" title='${data
      .toString()
      .escape()}' style="max-width: 30em;">
