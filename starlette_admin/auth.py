...
from starlette_admin.helpers import wrap_endpoint_with_kwargs, strip_host_filter
    ...
    async def dispatch(
        ...
        return RedirectResponse(
            "{url}?{query_params}".format(
                url=strip_host_filter(request.url_for(request.app.state.ROUTE_NAME + ":login")),
