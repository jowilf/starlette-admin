---
title: Interfaces d'administration extensibles pour FastAPI & Starlette
...
<div class="home-hero">
  <a class="home-badge" href="changelog/">
    ...
    Nouvelle documentation &nbsp;·&nbsp; Découvrez les changements
  </a>
  <h1 class="home-title">Interfaces <span class="home-gradient">d'administration</span> extensibles<br>pour FastAPI &amp; Starlette</h1>
  <p class="home-sub">Générez une interface d'administration complète à partir de vos modèles SQLAlchemy, SQLModel, Beanie, MongoEngine ou Tortoise ORM. Construit sur le kit UI <a href="https://tabler.io">Tabler</a>, starlette-admin vous offre des pages de liste, des formulaires générés automatiquement, des exportations de données et une authentification sécurisée. Configurez l'ensemble de l'interface en Python, sans écrire la moindre ligne de frontend.</p>
  <div class="home-actions">
    <a class="md-button md-button--primary home-btn" href="getting-started/quickstart/">Commencer</a>
  ...
  <div class="home-shot">
    <img src="assets/images/list-preview.png" alt="tableau de bord starlette-admin affichant des widgets statistiques, des tableaux d'activité récente et une barre latérale pour les vues de modèles" loading="lazy">
  </div>
</div>

<h2 class="home-section-title">Fonctionnalités intégrées</h2>
<p class="home-lede">Tout ce dont vous avez besoin fonctionne dès l'installation. Chaque fonctionnalité principale inclut des points d'extension documentés, afin que vous puissiez l'adapter à vos besoins.</p>
...
<div class="home-cards">
  <a class="home-card" href="user-guide/views/">
    ...
    <h3>Tableaux</h3>
    <p>Parcourez, recherchez et triez vos données avec pagination, tri multi-colonnes et URL préservant l'état. Modifiez les champs directement depuis la page de liste.</p>
  </a>
  <a class="home-card" href="user-guide/filters/">
    ...
    <h3>Filtres</h3>
    <p>Construisez des requêtes AND/OR imbriquées dans l'interface, avec des opérateurs adaptés aux types pour le texte, les nombres, les dates et les booléens.</p>
  </a>
  <a class="home-card" href="user-guide/fields/">
    ...
    <h3>Formulaires &amp; téléversements</h3>
    <p>Générez automatiquement des formulaires pour plus de 25 types de champs et pour les données relationnelles. Envoyez les fichiers téléversés vers un stockage local ou S3.</p>
  </a>
  <a class="home-card" href="user-guide/actions/">
    ...
    <h3>Actions</h3>
    <p>Créez des opérations groupées et au niveau des lignes avec des décorateurs Python standard. Contrôlez chaque exécution par des fenêtres modales de confirmation et des formulaires de charge utile personnalisés.</p>
  </a>
  <a class="home-card" href="user-guide/export-import/">
    ...
    <p>Exportez des enregistrements vers CSV, Excel, JSON, PDF ou tout format pris en charge par tablib. Importez des données en masse grâce à un assistant basé sur l'aperçu qui valide chaque ligne avant écriture dans la base de données.</p>
  </a>
  <a class="home-card" href="user-guide/auth/">
    ...
    <p>Connectez le fournisseur d'authentification que vous utilisez déjà. Déployez avec des réglages prêts pour la production, incluant la protection CSRF et des limites intégrées pour les exportations et importations.</p>
  </a>
  <a class="home-card" href="user-guide/inline-forms/">
    ...
    <h3>Formulaires en ligne</h3>
    <p>Gérez les données relationnelles sur place. Modifiez les enregistrements enfants dans le formulaire du modèle parent sans quitter la page.</p>
  </a>
  ...
  <a class="home-card" href="user-guide/i18n/">
    ...
    <h3>i18n &amp; fuseaux horaires</h3>
    <p>Servez le panneau d'administration en plusieurs langues, avec un formatage tenant compte des paramètres régionaux et une gestion précise des fuseaux horaires, dès l'installation.</p>
  </a>
</div>
...
<div class="home-code-head">
  ...
  <h2 class="home-section-title">Tout est en Python</h2>
  <p class="home-lede">Créez une interface d'administration complète avec une API Python pure conçue pour le <strong>développement rapide</strong>, la <strong>lisibilité de la syntaxe</strong> et la <strong>maintenabilité à long terme</strong>.</p>
</div>
...
=== "Vues"
    ...
    Définissez la recherche, le tri, l'ordre par défaut et les formats d'exportation avec de simples attributs de classe. Organisez vos formulaires de création et de modification avec `form_layout`.
...
=== "Filtres"
    ...
    Étendez le générateur de requêtes intégré avec des filtres personnalisés correspondant à vos règles métier. Vous pouvez appliquer directement les opérations souhaitées au modèle de base de données sous-jacent.
...
=== "Actions"
    ...
    Associez des opérations métier avec un simple décorateur. Les fenêtres modales de confirmation, les formulaires personnalisés et les messages flash sont intégrés au framework.
...
=== "Tableau de bord"
    ...
    Composez la page d'accueil de l'administration à partir de widgets statistiques, graphiques et tableaux qui interrogent des données en direct à chaque requête.
...
<h2 class="home-section-title">Plug-ins &amp; extensions</h2>
<p class="home-lede">Chaque couche est remplaçable. Empaquetez des fonctionnalités sous forme de plug-ins autonomes, ou connectez-vous à un point d'extension dédié pour adapter le framework à votre domaine.</p>

<div class="home-plugins">
  <div class="home-plugin-panel">
    <span class="home-eyebrow hc-violet">Plug-ins prêts à l'emploi</span>
    <h3>Des plug-ins sans code superflu</h3>
<p>Installez un paquet de plug-in et passez-le à votre instance <code>Admin</code>. Les champs, convertisseurs, templates et ressources se connectent automatiquement entre eux.</p>
    ...
    <a class="home-more" href="advanced/plugins/">Lire le guide des plug-ins</a>
  </div>
  <div class="home-plugin-panel">
    <span class="home-eyebrow hc-emerald">Points d'extension</span>
    <h3>Se connecter à n'importe quel composant</h3>
    <p>Des interfaces prédéfinies vous permettent de remplacer ou d'étendre chaque préoccupation de manière indépendante. Créez une sous-classe de la classe de base dont vous avez besoin et enregistrez-la. Vous pouvez personnaliser tout, du flux d'authentification aux formats d'exportation.</p>
    <ul class="home-hooks">
      ...
      <li><a href="user-guide/export-import/"><span>Exportateurs</span><code>BaseExporter</code></a></li>
      <li><a href="user-guide/export-import/"><span>Importateurs</span><code>BaseImporter</code></a></li>
      ...
      <li><a href="user-guide/custom-views/"><span>Widgets de tableau de bord</span><code>BaseWidget</code></a></li>
