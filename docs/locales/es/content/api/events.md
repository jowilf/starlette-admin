---
title: Referencia de la API de eventos
description: Documentación de referencia de la API para el sistema de eventos y los
  hooks en starlette-admin.
...
??? info "Traducción automática supervisada"
    ...
    [Leer la versión original en inglés](https://jowilf.github.io/starlette-admin/api/events/)
<!-- translation-notice:end -->

# Eventos

Referencia completa de atributos y métodos del sistema de eventos, generada a partir de las docstrings. Para una guía orientada a tareas, consulte [Eventos](../advanced/events.md).
