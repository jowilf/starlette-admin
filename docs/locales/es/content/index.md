...
<div class="home-hero">
  ...
  <h1 class="home-title"><span class="home-gradient">Interfaces de administración</span> extensibles<br>para FastAPI y Starlette</h1>
  <p class="home-sub">Genere una interfaz de administración completa a partir de sus modelos de SQLAlchemy, SQLModel, Beanie, MongoEngine o Tortoise ORM. Basado en el kit de UI <a href="https://tabler.io">Tabler</a>, starlette-admin le ofrece vistas de lista, formularios generados automáticamente, exportación de datos y autenticación segura. Configure toda la interfaz en Python, sin escribir código de frontend.</p>
  ...
  <div class="home-shot">
    <img src="assets/images/list-preview.png" alt="panel de control de starlette-admin que muestra widgets estadísticos, tablas de actividad reciente y una barra lateral para las vistas de modelos" loading="lazy">
  </div>
</div>

<h2 class="home-section-title">Funcionalidades integradas</h2>
<p class="home-lede">Todo lo que necesita funciona desde el primer momento. Cada funcionalidad principal incluye puntos de extensión documentados, para que pueda adaptarla a sus requisitos.</p>
...
<div class="home-cards">
  <a class="home-card" href="user-guide/views/">
    ...
    <h3>Tablas</h3>
    <p>Explore, busque y ordene sus datos con paginación, ordenación por varias columnas y URL que conservan el estado. Edite los campos directamente desde la vista de lista.</p>
  </a>
  ...
  <a class="home-card" href="user-guide/fields/">
    ...
    <p>Genere formularios automáticamente para más de 25 tipos de campos y para datos relacionales. Envíe las cargas de archivos a almacenamiento local o S3.</p>
  </a>
  <a class="home-card" href="user-guide/actions/">
    ...
    <h3>Acciones</h3>
    <p>Cree operaciones por lotes y a nivel de fila con decoradores estándar de Python. Proteja cada ejecución con ventanas modales de confirmación y formularios de carga útil personalizados.</p>
  </a>
  <a class="home-card" href="user-guide/export-import/">
    ...
    <p>Exporte registros a CSV, Excel, JSON, PDF o cualquier formato compatible con tablib. Importe datos en bloque con un asistente que muestra primero una vista previa y valida cada fila antes de escribir en la base de datos.</p>
  </a>
  <a class="home-card" href="user-guide/auth/">
    ...
    <p>Conecte el proveedor de autenticación que ya utiliza. Realice el despliegue con valores predeterminados listos para producción, incluida la protección CSRF y límites integrados para exportaciones e importaciones.</p>
  </a>
  ...
  <a class="home-card" href="user-guide/custom-views/">
    ...
    <p>Cree una página de inicio con widgets integrados de estadísticas, gráficos y tablas, o reemplácela con una vista completamente personalizada.</p>
  </a>
  <a class="home-card" href="user-guide/i18n/">
    ...
    <p>Sirva la interfaz de administración en varios idiomas, con formato adaptado a la configuración regional y manejo preciso de zonas horarias desde el primer momento.</p>
  </a>
</div>
...
<div class="home-code-head">
  ...
  <p class="home-lede">Cree una interfaz de administración completa con una API puramente Python diseñada para el <strong>desarrollo rápido</strong>, la <strong>sintaxis legible</strong> y el <strong>mantenimiento a largo plazo</strong>.</p>
</div>

=== "Montar la interfaz de administración"
...
=== "Campos"
    ...
    Sobrescriba cualquier campo detectado automáticamente para controlar la validación, la visibilidad por página y cómo starlette-admin lee y muestra los valores.
...
=== "Acciones"
    ...
    Adjunte operaciones de negocio con un solo decorador. Las ventanas modales de confirmación, los formularios personalizados y los mensajes flash están integrados en el framework.
...
=== "Autenticación"
    ...
    Implemente tres métodos estándar alrededor de su propia verificación de credenciales. starlette-admin se encarga de la página de inicio de sesión, las sesiones y las redirecciones.
...
=== "Panel de control"
    ...
    Componga la página de inicio de la interfaz de administración con widgets de estadísticas, gráficos y tablas que consultan datos en vivo en cada solicitud.
...
<p class="home-lede">Cada capa es reemplazable. Empaquete funcionalidades como plugins autocontenidos, o conéctese a un punto de extensión dedicado para adaptar el framework a su dominio.</p>

<div class="home-plugins">
  <div class="home-plugin-panel">
    <span class="home-eyebrow hc-violet">Plugins listos para usar</span>
    <h3>Plugins sin código repetitivo</h3>
<p>Instale un paquete de plugin y páselo a su instancia de <code>Admin</code>. Los campos, convertidores, plantillas y recursos se conectan entre sí automáticamente.</p>
    ...
    <a class="home-more" href="advanced/plugins/">Leer la guía de plugins</a>
  </div>
  <div class="home-plugin-panel">
    <span class="home-eyebrow hc-emerald">Puntos de extensión</span>
    <h3>Conéctese a cualquier componente</h3>
    <p>Las interfaces predefinidas le permiten sustituir o extender cada aspecto de forma independiente. Cree una subclase de la clase base que necesite y regístrela. Puede personalizar todo, desde el flujo de autenticación hasta los formatos de exportación.</p>
    <ul class="home-hooks">
      ...
      <li><a href="user-guide/custom-views/"><span>Widgets del panel de control</span><code>BaseWidget</code></a></li>
      <li><a href="advanced/templates/"><span>Plantillas</span><code>templates_dir</code></a></li>
    </ul>
    <a class="home-more" href="advanced/extension-points/">Explorar todos los puntos de extensión</a>
  </div>
</div>
