...
class Car(BaseModel):
    passengers: list[Link["Parent"]] | None = None
...
class TestBeanieHelpers:
    ...
    async def test_normalize_field_list_invalid_tuple(self):
        with pytest.raises(ValueError, match="Invalid argument"):
            normalize_field_list([("name", "not-a-bool")], is_default_sort_list=True)
